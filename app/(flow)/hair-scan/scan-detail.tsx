...
//   // Replace nutrients mapping
//   const nutrients: Nutrient[] = (data?.nutritions ?? []).map((n: any) => ({
//     id: n.id,
//     name: n.name,
//     description: n['how to improves'] ?? n.benefit ?? '',
//     imageUrl: { uri: n['image url'] ?? n.icon_url ?? '' },
//   }));
...
//     imageUrl: r.image_url,
//     tags: [
//       r.meal_type ? r.meal_type.charAt(0).toUpperCase() + r.meal_type.slice(1) : 'Meal',
//       ...(r.tags ?? []),
//     ],
//   }));
...
// app/(flow)/hair-scan/hair-scan-detail.tsx  (history detail screen)
import { ImageSourcePropType, ScrollView, View } from 'react-native';
import React from 'react';
import { SafeAreaView } from 'react-native-safe-area-context';
import { useLocalSearchParams, useRouter } from 'expo-router';
