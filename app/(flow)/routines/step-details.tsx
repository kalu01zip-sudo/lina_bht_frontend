...
// import { ClockIcon, CalendarIcon, TargetIcon, ArrowRightIcon } from '@/components/icons';
...
//                       <ClockIcon size={14} color="#977857" />
//                       <Text className="text-descriptionTextColor font-outfitMedium text-[12px]">
//                         Duration
//                       </Text>
//                     </View>
...
//                   <View className="flex-1">
//                     <View className="mb-1 flex-row items-center gap-1">
//                       <CalendarIcon size={14} color="#977857" />
//                       <Text className="text-descriptionTextColor font-outfitMedium text-[12px]">
//                         Frequency
//                       </Text>
//                     </View>
