...
// ── Fallback image (outside component, module-level constant) ─────────────────
const PRODUCT_FALLBACK_IMAGE = require('@/assets/images/product_analysis_sample_image.jpg');

// ── Safe image source helper ──────────────────────────────────────────────────
const safeProductImageSource = (imageUrl: string | null | undefined): ImageSourcePropType =>
  imageUrl ? { uri: imageUrl } : PRODUCT_FALLBACK_IMAGE;
    ...
    ? [
        {
          ...
          ImageUri: safeProductImageSource(data.product?.image_url),
        },
        {
          id: 'allergy_risk',
          title: 'Allergy Risk',
